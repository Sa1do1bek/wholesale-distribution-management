...
import com.wholesale.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/login", "/register", "/dashboard", "/customers-page", "/products-page", "/inventory-page", "/orders-page").permitAll()
